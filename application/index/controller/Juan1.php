...
class Juan1 extends Controller{
    ...
    public function juan_add1(){
        $uid=session('uid');
        $userlist=model('juan');
        $info=$userlist->juan_dan_select($uid);
    ...
    public function juan_much_add(){
        $uid=session('uid');
        $userlist=model('juan');
        $info=$userlist->juan_duo_select($uid);
        $this->assign('message',$info);
...
//        die();
    ...
    public function juan_judge_add(){
        $uid=session('uid');
        $userlist=model('juan');
        $info=$userlist->juan_judge_select($uid);
        $this->assign('message',$info);
...
//        die();
    ...
    public function juan_object_add(){
        $uid=session('uid');
        $userlist=model('juan');
        $info=$userlist->juan_object_select($uid);
        $this->assign('message',$info);
...
//        die();
    ...
    public function juan_select(){
        ...
        $msginfo=$info->shijuan_dan_select($uid);
    ...
    public function juan_select1(){
        ...
        $msginfo=$info->shijuan_much_select($uid);
    ...
    public function juan_select2(){
        ...
        $msginfo=$info->shijuan_judge_select($uid);
    ...
    public function juan_select3(){
        ...
        $msginfo=$info->shijuan_object_select($uid);
    ...
    public function pg1(){
        ...
        $userlist=model('xs');
        $msginfo=$userlist->xs_name($username);
        $this->assign('message',$msginfo);
        return $this->fetch('object/object_pg1T');
    }
    public function pg(){
        $name=input('kc_student');
        $userlist=model('xs');
...
//        print_r($number);die;
        ...
        return $this->fetch('object/object_pgT');
    }
